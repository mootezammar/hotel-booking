...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 mb:pb-35 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row'>
              ...
              <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                ...
                <div className="flex flew-row ">
                  <img src={assets.locationIcon} alt="location-icon" className='pr-1' />
                  <span>{ booking.hotel.address}</span>
                </div>
                <div className='flex flew-row'>
                  <img src={assets.guestsIcon} alt="guests-icon" className='pr-1'  />
                  <span>Guests: { booking.guests}</span>
                </div>
                <p>Total: { booking.totalPrice}DT</p>
              </div>
            </div>

              {/*date and taiming */}
            <div className='flex flex-row md:items-center md:gap-12 mb-5 gap-8'>
              <div>
                <p>Check-In:</p>
