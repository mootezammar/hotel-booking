...
const AllRooms = () => {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                        ...
                        <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-600 last:pb-30 last:border-0'>
                            ...
                            <div className='md:w-1/2 flex flex-col gap-2'>
                                ...
                                <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                                    ...
                                    <p className='text-xl font-medium text-gray-700'>{room.pricePerNight} Dt /night</p>
                                </div>
                            </div>
                        </div>
            ...
            {/*Filters */}
            <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 ml-7'>
                <div className={`flex items-center justify-between px-5 py-2.5 min-lg:border-b border-gray-300 ${openFilters && "border-b"}`}>
                    <p className='text-base font-medium text-gray-800'>FILTERE</p>
