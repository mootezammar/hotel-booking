...
export const createBooking = async (req, res) => {
    try {
        ...
        res.json({ success: true, message: "Booking create successfuly" })
...
export const getUserBookings = async (req, res) => {
    try {
        ...
        const bookings = Booking.find({ user }).populate("room hotel").sort({ createAt: -1 })
...
export const getHotelBookings = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({ success: false, message: "failed to fetch bookings dashboardData" })
